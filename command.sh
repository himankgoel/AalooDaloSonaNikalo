...
touch input1.txt
touch original_output.txt
touch brute_output.txt
touch dont_show_on_terminal.txt
...
g++ -std=c++17 solution.cpp -o original || { echo ${bold}${orange}Compilation Error${reset} in $1.cpp; exit 1; }
